...
import { AlcoholItem, Item } from "../types/types";
      ...
      <Card>
        ...
        <Box display="flex" flexDirection={mobile ? `column` : "row"}>
          <CardMedia
            ...
            image={item.image ? item.image : placeholderImg}
            title="Image of Item"
          />
          <CardContent sx={{ margin: "auto 0" }}>
            ...
            ></div>
            <div>
              {item.itemType === "Alcoholic Beverage" && (
                <div
                  style={{
                    display: "grid",
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ fontWeight: 600 }}
                  >
                    {(item as AlcoholItem).alcoholType}
                  </Typography>
                  <Typography
                    variant="body1"
                    color="text.secondary"
                    sx={{ fontWeight: 600 }}
                  >
                    {(item as AlcoholItem).alcoholContent}
                  </Typography>
                </div>
              )}
            </div>
